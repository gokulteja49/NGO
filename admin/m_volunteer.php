...
// Fetch only users who are volunteers
...
<body class="cbp-spmenu-push">
    ...
    <div class="table-responsive">  <!-- Added for responsive table -->
        <table class="table table-bordered table-striped"> <!-- Improved styling -->
            <thead class="thead-dark"> <!-- Dark header for better readability -->
                <tr>
                    <th>ID</th>
                    <th>Name</th>
                    <th>Email</th>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo htmlspecialchars($row1->user_id); ?></td>
                    <td><?php echo htmlspecialchars($row1->name); ?></td>
                    <td><?php echo htmlspecialchars($row1->email); ?></td>
                    <td><?php echo htmlspecialchars($row1->contact); ?></td>
                    <td>
                        <a href="more_v.php?moreid=<?php echo htmlspecialchars($row1->user_id); ?>" class="btn btn-primary btn-sm">
                            More details..
                        </a>
                    </td>
                </tr>
