      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="m_donation.php">
                <i class="fa fa-laptop"></i>
                <span>Donation</span>
                </a>
                <ul class="treeview-menu">
                  <li><a href="m_donation.php"><i class="fa fa-angle-right"></i> Money_donation</a></li>
                  <li><a href="c_history.php"><i class="fa fa-angle-right"></i> campaign donation</a></li>
                
                </ul>
              </li>
              <li class="treeview">
                <a href="donation_cards.php">
                <i class="fa fa-laptop"></i> <span>Manage special donation</span>
                </a>
              </li>
              <li class="treeview">
                <a href="admin_campaigns.php">
                <i class="fa fa-laptop"></i> <span>Manage campaigns</span>
                </a>
              </li>
              ...
              <li class="treeview">
                <a href="blogs_m.php">
                <i class="fa fa-laptop"></i> <span>Manage Blogs</span>
                </a>
              </li>
